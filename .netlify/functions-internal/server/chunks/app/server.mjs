...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-1d0b8e9c.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-5ce5bc14.mjs').then((m) => m.default || m)
  },
  {
    name: "mightchange",
    path: "/mightchange",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/mightchange-1020e90a.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-9ecfbe97.mjs').then((r) => r.default || r));
